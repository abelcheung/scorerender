	...
	if ( !empty ($errmsgs) )
	{
		foreach (array_values ($errmsgs) as $m)
		{
			...
			elseif ($sr_adm_msgs[$m]['level'] == MSG_FATAL)
				echo '<div id="scorerender-error-' . $sr_adm_msgs[$m] . '" class="updated" style="background-color: #800000; color: white;"><p><strong>' . sprintf (__('ERROR: %s', TEXTDOMAIN), $sr_adm_msgs[$m]['content']) . "</strong></p></div>\n";
		}
	}
	else
